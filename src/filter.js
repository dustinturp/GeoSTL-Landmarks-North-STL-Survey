...
class FilterComponent extends React.PureComponent {
  constructor(props) {
    ...
    const keysFromData = [
      {name: 'McKee Survey Results - All_data_Any Structures Here?', prettyName: 'Structure'},
      {name: 'McKee Survey Results - All_data_Condition', prettyName: 'Condition'},
      {name: 'McKee Survey Results - All_data_Does a roof exist?', prettyName: 'Roof Status'},
      {name: 'McKee Survey Results - All_data_Yard Maintained', prettyName: 'Yard Maintained'},
    ];
    this.state = {
      operator: '==',
      key: '',
